...
const animals_vehicles_intro = {
    ...
    on_load: () => {
        ...
        setTimeout(() => {
            ...
            if (a) a.style.border = '6px solid blue';
        }, 8000);

        setTimeout(() => {
            const a = document.getElementById('a');
            if (a) a.style.border = 'none';
        }, 9500);
        ...
        setTimeout(() => {
            ...
            if (b) b.style.border = '6px solid blue';
        }, 12500);
...
const car = {
    ...
    on_finish: (trialData) => {
        ...
        const choices = ['box_dog', 'box_car'];
        trialData.selected_item = choices[trialData.response];
    },
    data: {
        stimulus_item: 'car',
        choice_0: 'box_dog',
...
// Randomly assign to one of two trial conditions
const conditions = [
    // Silence
    //[...silence_condition],
    // Horn - Predictable
