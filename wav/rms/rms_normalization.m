files = {'final.wav', 'noisy_warn.wav', 'p_store_v4_smoothed.wav', 'prompt.wav', 'ready.wav', 'target_smoothed.wav', 'up_store_v3_smoothed.wav'};
...
for i = 1:length(files)
    ...
    threshold = 0.10 * max(local_rms); % speech activity threshold
