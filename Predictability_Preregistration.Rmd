...
```{r graphs}
plot_model(pred_cont_glmer, type = "pred", vars = c("avg_accuracy", "age"),
...
We will use Bayes factors for determining if our regression models and t-tests show a significant difference between H0 and H1. 
